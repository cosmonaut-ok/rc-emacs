...
LATEX_MATH_PREVIEW_URL="https://www.emacswiki.org/emacs/download/latex-math-preview.el"
function pkg_install
{
    ...
    get_url_with_name latex-math-preview.el $LATEX_MATH_PREVIEW_URL
    copy_to_local latex-math-preview.el latex
}
